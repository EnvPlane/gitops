...
type secretResolver interface {
	Resolve(ctx context.Context, secret domain.SecretReference) (string, error)
}

type secretResolverImpl struct {
	client     *http.Client
...
func (r *secretResolverImpl) Resolve(ctx context.Context, secret domain.SecretReference) (string, error) {
...
func resolveEnv(secret domain.SecretReference) (string, error) {
	...
	if reference == "" {
		return "", fmt.Errorf("secret reference %q has empty reference", strings.TrimSpace(secret.ID))
	}
...
func (r *secretResolverImpl) resolveKubernetes(ctx context.Context, secret domain.SecretReference) (string, error) {
...
func (r *secretResolverImpl) resolveVault(ctx context.Context, secret domain.SecretReference) (string, error) {
